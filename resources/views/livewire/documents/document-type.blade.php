                        ...
                        <div class="rounded-t mb-0 px-4 py-3 border-0">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if ($isOpen)
                                        @include('livewire.documents.document-type-create')
                                    @endif
                                    @if ($deleteModal)
                                        @include('livewire.documents.document-type-delete')
                                    @endif
                                                ...
                                                @forelse ($documentTypes as $doc)
                                                    <tr cl>
                                                        ...
                                                        <td
                                                            ...
                                                            <button wire:click="confrimDeleteModal({{ $doc->id }})"
