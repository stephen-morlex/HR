<div>
    <x-jet-dialog-modal wire:model="isOpen">
        ...
        <x-slot name="title">
            ...
            <div class="flex items-start justify-between p-5 rounded-t">
                <h3 class="text-3xl font-semibold">
                    @if ($policy_id)
                        <h1 class="text-gray-700 font-bold">Edit {{ $name }} Company Policy </h1>
                    @else
                        <h1 class="text-gray-700 font-bold">Create Company Policy</h1>
                    @endif
                </h3>
        ...
        <x-slot name="content">
            ...
            <div class="mt-2">
                <x-jet-label class="font-light text-gray-600" for="attachment" value="{{ __('Attachment') }}" />
                <x-jet-input id="attachment" type="file"
                    class="w-full mt-2 mb-6 px-6 py-3 border rounded-lg text-lg text-gray-700 focus:outline-none"
