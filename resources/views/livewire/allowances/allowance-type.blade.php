                        ...
                        <div class="rounded-t mb-0 px-4 py-3 border-0">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if ($isOpen)
                                        @include('livewire.allowances.create-type')
                                    @endif
                                    @if ($deleteModal)
                                        @include('livewire.allowances.delete-type')
                                    @endif
                                                    ...
                                                    <tr cl>
                                                        <th
                                                            ...
                                                            <p class="text-gray-900 capitalize tracking-wide">
                                                                {{ $allowanceType->name }} </p>
                                                        </th>

                                                        <td
                                                            class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                                                            {{ $allowanceType->created_at->diffForHumans() }}
                                                        </td>
                                                        <td
                                                            class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                                                            <button wire:click="edit({{ $allowanceType->id }})"
                                                            ...
                                                            <button
                                                                wire:click="confrimDeleteModal({{ $allowanceType->id }})"
