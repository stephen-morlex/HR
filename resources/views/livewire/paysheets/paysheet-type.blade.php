                        ...
                        <div class="rounded-t mb-0 px-4 py-3 border-0">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if ($isOpen)
                                        @include('livewire.paysheets.paysheet-type-create')
                                    @endif
                                    @if ($deleteModal)
                                        @include('livewire.paysheets.paysheet-type-delete')
                                    @endif
                                                ...
                                                @forelse ($paysheetTypes as $pt)
                                                    <tr cl>
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $pt->created_at->diffForHumans() }}
                                                        </td>
                                                        <td
                                                            class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                                                            <button wire:click="edit({{ $pt->id }})"
                                                            ...
                                                            <button wire:click="confrimDeleteModal({{ $pt->id }})"
