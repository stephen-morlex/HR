                        ...
                        <div class="rounded-t mb-0 px-4 py-3 border-0">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if ($isOpen)
                                        @include('livewire.announcements.create')
                                    @endif
                                    @if ($deleteModal)
                                        @include('livewire.announcements.delete')
                                    @endif
                                        ...
                                        <table class="items-center w-full bg-transparent border-collapse">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th
                                                        class="px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                                        <a wire:click.prevent="sortBy('start_date')" role="button"
                                                    ...
                                                    <th
                                                        class="px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                                        <a wire:click.prevent="sortBy('end_date')" role="button"
                                                            href="#" class="flex items-center">
                                                            End Date
                                                            @include('includes._sort-icon', ['field' => 'created_at'])
                                                        </a>
                                                ...
                                                @forelse ($announcements as $announcement)
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            <button
                                                                wire:click="confrimDeleteModal({{ $announcement->id }})"
