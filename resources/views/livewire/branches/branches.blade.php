                    ...
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <div class="flex items-center justify-between">
                                    <button wire:click="create()"
                                        class="flex items-center bg-blue-50 p-2 text-blue-700 shadow-sm rounded-md cursor-pointer">
                                        <svg viewBox="0 0 24 24" class="h-6 w-6 mr-2 fill-current text-blue-500">
                                    ...
                                    <button wire:click="export()"
                                        class="ml-4 flex items-center bg-green-50 p-2 text-green-700 shadow-sm rounded-md cursor-pointer">
                                        <svg viewBox="0 0 24 24" class="h-6 w-6 fill-current text-green-700 mr-2 ">
                                            <path fill="none" d="M0 0h24v24H0V0Z" />
                                            <path
                                    ...
                                    @endif
                                    @if ($deleteModal)
                                        @include('livewire.branches.delete')
                                    @endif
                        ...
                        <div class="block w-full overflow-x-auto">
                            <div class="flex flex-wrap mt-4">
                                <div class="w-full mb-12 px-4">
                                    <div class="block w-full overflow-x-auto">
                                        {{-- <livewire:branches.branch-table searchable="name" exportable /> --}}
                                        <!-- Projects table -->
                                                ...
                                                @forelse ($branches as $item)
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            <button wire:click="confrimDeleteModal({{ $item->id }})"
